...
export const ap = new Aprendiz("Hector Fabio", "Varon Bonilla", "avatar.png", 30, NivelEducativo.POSGRADO, cursos);
...
function mostrarCursosAprendiz(cursos: Curso[]):void{
    let cursosTboby:HTMLElement =document.createElement("tbody");
    ...
    for(let curso of cursos)
    {
        ...
        <td>${curso.anio}</td>`;
        cursosTboby.appendChild(trElement);
        index++;
    }
    cursosTable.appendChild(cursosTboby);
}